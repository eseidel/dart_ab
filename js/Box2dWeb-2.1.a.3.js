...
var b2BoundValues = Box2D.inherit({
...
var b2WorldManifold = Box2D.inherit({
  initialize: function () {
    ...
    for (var x = 0; x < b2Settings.b2_maxManifoldPoints; x++) {
      this.m_points[x] = new b2Vec2();
    }
  },
  _initialize_circles: function(manifold, xfA, radiusA, xfB, radiusB) {
    var tMat = xfA.R;
  ...
  _initialize_faceA: function(manifold, xfA, radiusA, xfB, radiusB)  {
    var tMat = xfA.R;
  ...
  _initialize_faceB: function(manifold, xfA, radiusA, xfB, radiusB) {
    var tMat = xfB.R;
    var tVec = manifold.m_localPlaneNormal;
    var normalX = tMat.col1.x * tVec.x + tMat.col2.x * tVec.y;
    var normalY = tMat.col1.y * tVec.x + tMat.col2.y * tVec.y;
  ...
  Initialize: function(manifold, xfA, radiusA, xfB, radiusB) {
    ...
    switch (manifold.m_type) {
      ...
      case b2Manifold.e_faceA:
        this._initialize_faceA(manifold, xfA, radiusA, xfB, radiusB);
        break;
      case b2Manifold.e_faceB:
        this._initialize_faceB(manifold, xfA, radiusA, xfB, radiusB);
        break;
    }
  },
});
...
var b2PolygonShape = Box2D.inherit({
  ...
  SetAsArray: function(vertices, vertexCount) {
    ...
    this.SetAsVector(vertices.slice(0), vertexCount);
  },
  /*
...
var b2ContactFilter = Box2D.inherit({
...
// FIXME(slighltyoff)
var b2ContactListener = Box2D.inherit({
...
// FIXME(slighltyoff)
var b2DestructionListener = Box2D.inherit({
  ...
  DrawShape: function(shape, xf, color) {
    switch (shape.m_type) {
      ...
      case b2Shape.e_polygonShape:
        ...
        var vertices = new Array(vertexCount); // FIXME(slighltyoff): map()
